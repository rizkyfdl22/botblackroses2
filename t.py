...
admin=["u23e78bfab772bd9ebb58f9e24433b938"]
creator=["u6bce522e47884e5feb92b6c0532c1cec"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u6bce522e47884e5feb92b6c0532c1cec"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
            elif msg.text in ["dil","fadil","Fadil","Fadd","Fadill"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Sekali lagi anda memanggil nama leader akan terkick!")
					kk.sendText(msg.to,"Tapi boong hehehe....")
            elif msg.text in ["wkwkwk"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"jangan ketawa itu sama aja ngundang kicker")
            elif msg.text in ["Boong mulu lu dasar bot..."]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"yauda si")
					kk.sendText(msg.to,"lu juga bot kampret....")
					kc.sendText(msg.to,"")
            elif msg.text in ["welcome"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"")
					kk.sendText(msg.to,"/peraturanbl")
#-----------------------------------------------
            elif msg.text in ["Selamat datang di •вℓacкʀoses•[INTI]"]:
				ki.sendText(msg.to,"/nmclan")
				kk.sendText(msg.to,"/lambang")
				kc.sendText(msg.to,"/keyword")
#-----------------------------------------------
            elif msg.text in ["Responsename","responsename"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Karl V1")
#-----------------------------------------------
